...
try{
    ...
    Write-Host -ForegroundColor Yellow `n"This step (#12) is not included in this program due to being done manually"`n
...
try{
    ...
    Write-Host -ForegroundColor Yellow `n"This step (#18) is not included in this program due to being done manually"`n
